...
window.addEventListener('load', function () {
  ...
  if (sliderCoaches) {
    var swiperCoaches = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.coaches__swiper', {
      loop: 'true',
      navigation: {
  ...
  if (sliderReviews) {
    var swiperReviews = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__swiper', {
      navigation: {
        nextEl: '.swiper-button--next',
        prevEl: '.swiper-button--prev'
      },
