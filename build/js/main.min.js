...
/* harmony import */ var _modules_reviews__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/reviews */ "./js/modules/reviews.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["addClassToTab"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["onTabsClick"])();
  Object(_modules_coaches__WEBPACK_IMPORTED_MODULE_5__["getCoachesSlider"])();
  Object(_modules_reviews__WEBPACK_IMPORTED_MODULE_6__["getReviewsSlider"])();

  if (document.querySelector('.form')) {
    Object(_modules_form__WEBPACK_IMPORTED_MODULE_4__["interactWithForm"])();
...
/*!*******************************!*\
  !*** ./js/modules/coaches.js ***!
  \*******************************/
/*! exports provided: getCoachesSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCoachesSlider", function() { return getCoachesSlider; });
var coachesList = document.querySelector('.coaches__swiper-wrapper');
var getCoachesSlider = function getCoachesSlider() {
  if (coachesList) {
    var coachesItems = coachesList.querySelectorAll('.swiper-slide');
    ...
    if (coachesItems) {
      coachesItems.forEach(function (item) {
        item.style.width = '100%';
      });
    }

    coachesButtons.forEach(function (item) {
...
/*!*******************************!*\
  !*** ./js/modules/reviews.js ***!
  \*******************************/
/*! exports provided: getReviewsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getReviewsSlider", function() { return getReviewsSlider; });
var reviewsList = document.querySelector('.reviews__swiper-wrapper');
var getReviewsSlider = function getReviewsSlider() {
  if (reviewsList) {
    var reviewsItems = reviewsList.querySelectorAll('.swiper-slide');
...
/*!****************************!*\
  !*** ./js/modules/tabs.js ***!
  \****************************/
/*! exports provided: addClassToTab, onTabsClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addClassToTab", function() { return addClassToTab; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onTabsClick", function() { return onTabsClick; });
var tabsBtn = document.querySelectorAll('.tabs__btn');
var tabs = document.querySelector('.tabs');
var tabsContents = document.querySelectorAll('.tabs__content');
var tabsHidden = document.querySelectorAll('[data-tabs-hidden]');
var addClassToTab = function addClassToTab() {
  tabsHidden.forEach(function (item) {
    item.classList.add('with-js');
  });
};
var onTabsClick = function onTabsClick() {
  if (tabs) {
    tabs.addEventListener('click', function (e) {
      if (e.target.classList.contains('tabs__btn')) {
        ...
        document.querySelector("[data-tabs-path=\"".concat(tabsPath, "\"]")).classList.add('is-active');
  ...
  var tabsHandler = function tabsHandler(path) {
    ...
    document.querySelector("[data-tabs-target=\"".concat(path, "\"]")).classList.add('is-active');
  };
};
...
/*!*****************************!*\
  !*** ./js/modules/video.js ***!
  \*****************************/
/*! exports provided: videoButton, video, playVideo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var videoButton = document.querySelector('.gym__btn');
